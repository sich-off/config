...
require("beautiful")
require("naughty")
require("textlayoutbox") -- my custom layoutbox
...
--mytextclock = awful.widget.textclock({align = "right"}, "【%Y年%m月%d日%H时%M分%S秒】", 1)
--mytextclock = awful.widget.textclock({align = "right"}, " [%F %T] ", 1)
mytextclock = awful.widget.textclock({align = "right"}, " [%T] ", 1)
...
for s = 1, screen.count() do
    ...
    -- Create an textbox widget which will contains an icon indicating which layout we're using.
    -- We need one layoutbox per screen.
    mylayoutbox[s] = textlayoutbox(s)
